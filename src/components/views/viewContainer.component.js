...
const ViewItem = props => {
  ...
  const viewPlantButtons = (
    <span className="d-flex w-100 p-2">
      ...
      <Link className="w-50 text-center py-1 ml-1" style={{backgroundColor: '#C3E991', color: '#47A025', borderRadius: '15px', boxShadow: 'inset rgba(66, 66, 66, 0.8) 0px 0px 5px'}} to={{ pathname: viewPlantURL, data: data}}>View Tray</Link>
    </span>)
...
// TODO: Submit button functionality
  ...
  let buttons = props.mode === 'viewSeed' ? viewSeedButtons : previewButtons ;
  buttons = props.mode === 'viewPlant' ? viewPlantButtons : previewButtons ;
